-- Update create_order to calculate shipping fee based on threshold
...
BEGIN
  ...
  INSERT INTO public.orders(id, order_number, customer_id, customer_name, customer_email,
    subtotal, discount_amount, total, status, payment_status, shipping_address, metadata, notes)
  VALUES (v_order_id, v_order_number, v_uid, _customer_name, _customer_email,
    ...
    _shipping_address,
    jsonb_build_object('payment_method', _payment_method, 'coupon_code', v_coupon_code, 'shipping_fee', v_shipping_fee),
    _notes);
  ...
  RETURN jsonb_build_object('id', v_order_id, 'order_number', v_order_number,
    'subtotal', v_subtotal, 'discount', v_discount, 'shipping_fee', v_shipping_fee, 'total', v_total);
END; $$;
